...
import tak.bo.irc.ircclient.service.message.CliMessage;
import tak.bo.irc.ircclient.service.message.ServMessage;
import tak.bo.irc.ircclient.service.server.*;
import tak.bo.irc.ircclient.service.utils.CLILogger;
...
public class MsgHandler {
    ...
    public void handdleMessage(String msg, SocketChannel channel) {
        ...
        Client client = getServer().getClientByChannel(channel);
        assert client != null;
    ...
    public void acceptNewClient(SocketChannel channel) {
        ...
        Client c = getServer().getClientByChannel(channel);
        if (c == null) {
